...
export const EXAM_110_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    "subject": "物理",
    "category": "",
    "question_text": "問2          熱力学における「閉じた系」において、熱、物質及び仕事のうち、外界とやりと\nりができるものだけをすべて挙げたのはどれか。1つ選べ。\n1     熱\n2     物質\n3     仕事\n4     熱、仕事\n5     物質、仕事\n6     熱、物質\n1",
    "choices": [
      {
        "key": 1,
        "text": "熱"
  ...
  },
  {
    ...
    "subject": "化学",
    "category": "",
    "question_text": "問 98        定量法に関する記述として正しいのはどれか。2つ選べ。\n1     本定量法の原理は、Volhard 法に基づいている。\n2     下線部アの標準液は、₀ . ₁ mol/L チオシアン酸アンモニウム液の標定に用いら\nれる。\n3     下線部イの指示薬の代わりにフルオレセインナトリウムを用いることができ\nる。\n4         ウ      に入る色は、橙色である。\n5         エ      に入る数字は、₂₀ . ₄₆ である。\n6",
    "choices": [
      {
        "key": 1,
        "text": "本定量法の原理は、Volhard 法に基づいている。"
      },
      {
        "key": 2,
        "text": "下線部アの標準液は、₀ . ₁ mol/L チオシアン酸アンモニウム液の標定に用いら"
      },
      {
        "key": 3,
        "text": "下線部イの指示薬の代わりにフルオレセインナトリウムを用いることができ"
      },
      {
        "key": 4,
        "text": "ウ      に入る色は、橙色である。"
  ...
  },
  {
    ...
    "subject": "生物",
    "category": "",
    "question_text": "問 103        以下の反応で、生成物を与える電子移動を示す一連の矢印が正しいのはどれ\nか。2つ選べ。\nO                                                           ONa\n1       H3C                              CH3                                 H3C              CH3\nH\nH\nH        B- H\nH Na\n＋\nO                                                        O\n2                                                                            H3C\nCH3NH                              CH3                                      N               CH3\nH\nH\nCH3                                                               CH3\n-\n3      H3C            O              H 3C      I                             H3C       OCH3\nCH3                                                               CH3\n＋\nH                                     NO2\n4                          ＋\nNO2                                 NO2\nCH3                                    CH3\nH3C             ＋\nH3C                                       H3C\n＋\n5                              CH3                                     CH3                                CH3\nH3C                                                                                   H3C\nH3C                                       H3C                                            Br\nBr-\n11",
    "choices": [
      {
        "key": 1,
        "text": "H3C                              CH3                                 H3C              CH3"
      },
      {
        "key": 2,
        "text": "H3C"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 3,
        "text": "ナイアシンの一種であるニコチン酸には「日本人の食事摂取基準（₂₀₂₀ 年"
      },
      {
        "key": 4,
        "text": "トウモロコシを主食とする地域では、ナイアシンの欠乏症に注意する必要があ"
      },
      {
        "key": 5,
        "text": "ナイアシンが過剰になると、頭蓋内圧の亢進が起こる。"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 3,
        "text": "発熱時には処方 ₁ の薬剤を増量する必要があるので、医師の指示を受けてくだ"
      },
      {
        "key": 4,
        "text": "幼児は成人よりも体重あたりの必要水分量が多いので、 ₁ 日合計 ₂ L 以上の水"
      },
      {
        "key": 5,
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 3,
        "text": "測定される pH は温度の影響を受けない。"
      },
      {
        "key": 4,
        "text": "校正された pH 計の電位を基準としてプール水の pH が測定される。"
      },
      {
        "key": 5,
        "text": "参照電極の内部液には飽和塩化アンモニウム水溶液が用いられる。"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 3,
        "text": "処方 ₁ の薬剤を ₅₅ ℃程度のお湯に崩壊・懸濁させ、とろみをつけて服用させ"
      },
      {
        "key": 4,
        "text": "むせたときは、息子さんの判断で、以降は処方 ₁ の薬剤の服用を中止してくだ"
      },
      {
        "key": 5,
        "text": "処方 ₂ の薬剤を内服薬のドネペジル塩酸塩錠に変更するように医師に提案でき"
      }
    ],
    "correct_answer": 1,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 3,
        "text": "錠剤が大きくて飲みにくい場合は、粉砕し水や微温湯に懸濁して服用してもよ"
      },
      {
        "key": 4,
  ...
  },
  {
    ...
    "subject": "実務",
    "category": "",
    "question_text": "問 216−217      保険薬局に勤務している薬剤師が、看護学校の講師を担当することになっ\nた。講義では、植物に含まれている麻薬成分が医療用麻薬として使用されているこ\nとを紹介することにした。最近、高度のがん疼痛のある患者が、その初回の服薬を\n躊躇した事例を経験したことから、その場合の対応や、現場での医療用麻薬の有効\nな使い方についても講義しようと考えている。患者が服薬を躊躇した事例の処方薬\nは、モルヒネ塩酸塩水和物徐放性カプセルとモルヒネ塩酸塩水和物内用液であっ\nた。\n問 216（実務）\n講義で伝える内容として、適切なのはどれか。2つ選べ。\n1 オピオイドを定期的に鎮痛に必要な量で投与すれば、がん患者の生命予後に影\n響を与えない。\n2 がん疼痛管理にオピオイドを使用する場合、精神依存が生じる可能性は低く、\nオピオイドの使用を控える理由とはならない。\n3 服薬を躊躇したこの高度のがん疼痛のある患者に対しては、弱オピオイドを提\n案する。\n4     高度の腎機能障害がある患者に対しては、この事例の処方薬の投与を推奨す\nる。\n5 がん疼痛の突出痛がある場合、オピオイドの徐放製剤をレスキュー薬として投\n与する。\n21\n問 217（物理・化学・生物）\nまた、講義ではモルヒネと同じ植物に含まれる麻薬成分である化合物Ｘについて\nも紹介し、化合物Ｘは一般用医薬品の鎮咳薬としても利用され、一部ではその濫用\nが問題になっていることを述べることにした。化合物Ｘの化学構造式と、その基原\nとなる植物写真の組合せとして、正しいのはどれか。1つ選べ。\nＡ                                     Ｂ                  Ｃ\nCH2\nCH3                                       CH3\nH   N                                     H   N          H    N\nH                                         H              HO\nO             OH                                          O\nH3C    O           H     H            H3C   O                      HO        H     O\nア                                         イ\n化学構造式              写真\n1           A                  ア\n2           B                  ア\n3           C                  ア\n4           A                  イ\n5           B                  イ\n6           C                  イ\n22",
    "choices": [
      {
        "key": 1,
        "text": "オピオイドを定期的に鎮痛に必要な量で投与すれば、がん患者の生命予後に影"
      },
      {
        "key": 2,
        "text": "がん疼痛管理にオピオイドを使用する場合、精神依存が生じる可能性は低く、"
      },
      {
        "key": 3,
        "text": "服薬を躊躇したこの高度のがん疼痛のある患者に対しては、弱オピオイドを提"
      },
      {
        "key": 4,
        "text": "高度の腎機能障害がある患者に対しては、この事例の処方薬の投与を推奨す"
      },
      {
        "key": 5,
        "text": "がん疼痛の突出痛がある場合、オピオイドの徐放製剤をレスキュー薬として投"
      }
    ],
    "correct_answer": 4,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 2,
        "text": "メタケイ酸アルミン酸マグネシウムは、ピレンゼピンで起こる便秘を防止する"
      },
      {
        "key": 3,
        "text": "本剤には食物の消化を促進する成分が含まれています。"
      ...
      {
        "key": 4,
        "text": "本剤の服用により、目のかすみ、異常なまぶしさなどの症状が現れることがあ"
      },
      {
        "key": 5,
        "text": "₂ 週間服用しても症状が治まらない場合は、さらに服用を継続してください。"
      }
    ],
    "correct_answer": 1,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 5,
        "text": "薬を食後服用としているのは、悪心・嘔吐の副作用を軽減させるねらいがあ"
      }
    ],
    "correct_answer": 2,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 2,
        "text": "酵素Ａによる反応は、アミノ基転移反応である。"
      },
      {
        "key": 3,
        "text": "酵素Ａによる反応は、ビタミン B6 に由来する補酵素によって促進される。"
      },
      {
        "key": 4,
        "text": "レボドパよりもドパミンの方が、脳内へ移行しやすい。"
      ...
      {
        "key": 5,
        "text": "代謝物Ｂは、レボドパ分子内のヒドロキシ基がメチル化されたものである。"
      }
    ],
    "correct_answer": 1,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 5,
        "text": "HPV（₁₆ 型／₁₈ 型）感染後に接種しても、がんを予防する効果があります。"
      }
    ],
    "correct_answer": 5,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 3,
        "text": "代謝性アルカローシスのリスクがあるため、生理食塩液や塩化カリウム製剤を"
      },
      {
        "key": 4,
        "text": "低カルシウム血症のリスクがあるため、活性型ビタミン D3 製剤を投与する。"
      },
      {
        "key": 5,
        "text": "腎不全が進行した場合、カリウム製剤を積極的に投与する。"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 5,
        "text": "薬液を拭き取った後は水を含ませたガーゼで拭き、さらに消毒用エタノールを"
      }
    ],
    "correct_answer": 1,
    "explanation": "",
  ...
  },
  {
    ...
    "subject": "実務",
    "category": "",
    "question_text": "問 246−247      ₃₀ 歳男性。以下の処方 ₁ ～ ₃ が記載された処方箋を持って薬局を訪れた。\nこの薬局では、 ₁ 名の薬学生が実習中であった。\n（処方 ₁ ）\nリスペリドン錠 ₁ mg    ₁ 回 ₁ 錠（ ₁ 日 ₃ 錠）\nスルピリド錠 ₁₀₀ mg   ₁ 回 ₁ 錠（ ₁ 日 ₃ 錠）\n₁日₃回       朝昼夕食後        ₁₄ 日分\n（処方 ₂ ）\nハロペリドール細粒 ₁ ％   ₁ 回 ₀ . ₆ g（ ₁ 日 ₀ . ₆ g）\n₁日₁回       朝食後      ₁₄ 日分\n（処方 ₃ ）\nラメルテオン錠 ₈ mg    ₁ 回 ₁ 錠（ ₁ 日 ₁ 錠）\n₁日₁回       就寝前      ₁₄ 日分\n1\n問 246（薬理）\n処方 ₁ ～ ₃ のいずれかの薬物に関する記述として、正しいのはどれか。2つ選\nべ。\n1     ドパミン D2 受容体に部分アゴニストとして作用することで、ドパミン神経系\nを安定化させる。\n2     ヒスタミン H1 受容体及びアドレナリン a1 受容体を刺激することで、統合失調\n症の陰性症状を改善する。\n3     ドパミン D2 受容体を遮断することで、統合失調症の陽性症状を改善する。\n4     c︲アミノ酪酸 GABAA 受容体のベンゾジアゼピン結合部位に結合することで、\n睡眠を誘発する。\n5     メラトニン MT1 及び MT2 受容体を刺激することで、睡眠︲覚醒リズムを正常\n化する。\n問 247（実務）\n指導薬剤師は、実務実習生に下表の換算値を用いて経口抗精神病薬のクロルプロ\nマジン換算量を算出する課題を出した。この患者の ₁ 日分のクロルプロマジン換算\n量はどれか。1つ選べ。\n（経口抗精神病薬の等価換算表）\n経口クロルプロマジン ₁₀₀ mg に\n薬物\n相当する換算値\nクロルプロマジン               ₁₀₀\nスルピリド                  ₂₀₀\nハロペリドール                 ₂\nリスペリドン                  ₁\n1     ₃₀₀ mg\n2     ₄₈₀ mg\n3     ₆₆₀ mg\n4     ₇₅₀ mg\n5     ₉₀₀ mg\n2",
    "choices": [
      {
        "key": 1,
        "text": "ドパミン D2 受容体に部分アゴニストとして作用することで、ドパミン神経系"
      },
      {
        "key": 2,
        "text": "ヒスタミン H1 受容体及びアドレナリン a1 受容体を刺激することで、統合失調"
      },
      {
        "key": 3,
        "text": "ドパミン D2 受容体を遮断することで、統合失調症の陽性症状を改善する。"
      },
      {
        "key": 4,
        "text": "c︲アミノ酪酸 GABAA 受容体のベンゾジアゼピン結合部位に結合することで、"
      },
      {
        "key": 5,
        "text": "メラトニン MT1 及び MT2 受容体を刺激することで、睡眠︲覚醒リズムを正常"
      }
    ],
    "correct_answer": 4,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 2,
        "text": "流通管理のため、空の PTP シートを回収すること。"
      },
      {
        "key": 3,
        "text": "脱毛の可能性があること。"
  ...
  },
  {
    ...
    "choices": [
      {
        "key": 1,
        "text": "補体 C₅ に結合することで、補体 C₅ を介した赤血球の破壊を抑制する。"
      },
      {
        "key": 2,
        "text": "チミジル酸合成酵素の補酵素として作用することで、赤血球の産生を促進す"
      },
      {
        "key": 3,
        "text": "ヘム合成酵素の補酵素として作用することで、ヘムの合成を促進する。"
      ...
      {
        "key": 5,
        "text": "低酸素誘導因子（HIF）プロリン水酸化酵素を阻害することで、HIF を介した"
      }
    ],
    "correct_answer": 4,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 2,
        "text": "リファンピシンの服用により、尿や便が橙赤色等に着色する可能性があるこ"
      },
      {
        "key": 3,
        "text": "イソニアジドの副作用として高尿酸血症があること。"
      ...
      {
        "key": 4,
        "text": "ピラジナミドは、チーズなどのチラミンを多く含む食品との相互作用により、"
      },
      {
        "key": 5,
        "text": "エタンブトールの副作用として視力障害があること。"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 4,
        "text": "b     消化管においてキレート形成によりニコチンの吸収が低下するため。"
      },
      {
        "key": 5,
        "text": "c"
  ...
  },
  {
    ...
    "choices": [
      {
        "key": 1,
        "text": "胃内 pH の上昇による溶解性の低下"
      },
      {
        "key": 2,
        "text": "核内受容体を介した小腸 P︲糖タンパク質の発現量増加"
      },
      {
        "key": 3,
        "text": "肝臓の OATP₁B₁ に対する競合阻害"
      },
      {
        "key": 4,
        "text": "代謝物による CYP₃A₄ の不可逆的阻害"
      },
      {
        "key": 5,
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 3,
        "text": "投与時に血管痛が出た場合は、次回から懸濁に用いる液をブドウ糖液に変更す"
      },
      {
        "key": 4,
        "text": "インラインフィルターを使用して投与することを確認する。"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 2,
        "text": "ポリソルベート ₈₀ は、微生物の発育を阻止する目的で添加されている。"
      },
      {
        "key": 3,
        "text": "精製白糖は、無痛化を目的に添加されている。"
  ...
  },
  {
    ...
    "subject": "実務",
    "category": "",
    "question_text": "問 284−285      ₈₂ 歳男性。夜中に咳込みが激しくなり、病院を受診したところ、気管支ぜ\nん息と診断され、処方 ₁ の薬剤が処方された。薬剤師は吸入練習機を用いて吸入指\n導を行い、薬剤を交付した。しかし、数日後、家族が薬局に来局し、「処方 ₁ の薬\n剤を吸入するとむせるようになり、吸入が困難になった」と話した。薬剤師が処方\n医にこの情報を提供したところ、再診察を行い処方 ₁ を処方 ₂ に変更した。\n（処方 ₁ ）\nアニュイティ ₁₀₀ ng エリプタ ₃₀ 吸入用           ₁本\n（注 1）\n₁ 回 ₂ 吸入   ₁日₁回   朝   吸入\n注 ₁ ：フルチカゾンフランカルボン酸エステルを含有するドライパウダー吸\n入器（DPI）\n。 ₁ 吸入でフルチカゾンフランカルボン酸エステルとし\nて ₁₀₀ ng を吸入できる。\n（処方 ₂ ）\nオルベスコ ₁₀₀ ng インヘラー ₅₆ 吸入用           ₁本\n（注 2）\n₁ 回 ₁ 吸入   ₁日₁回   朝   吸入\n注 ₂ ：シクレソニドを含有する加圧式定量噴霧器（pMDI）。 ₁ 吸入でシク\nレソニドとして ₁₀₀ ng を吸入できる。\n41\n問 284（薬剤）\n処方 ₁ と処方 ₂ の薬剤に関する記述として正しいのはどれか。2つ選べ。\n1     処方 ₁ と処方 ₂ の薬剤は、いずれも無菌試験法に適合する。\n2     処方 ₁ と処方 ₂ の薬剤は、いずれも吸入剤の空気力学的粒度測定法に適合す\nる。\n3     処方 ₁ の薬剤に用いられている容器は、薬剤を含むエアゾール缶、定量バルブ\nとアクチュエーター等から構成される。\n4     処方 ₂ の薬剤は、吸入量が一定となるように調製された固体粒子のエアゾール\nとして吸入する。\n5     処方 ₂ の薬剤には、耐圧性の密封容器が用いられる。",
    "choices": [
      {
        "key": 1,
        "text": "処方 ₁ と処方 ₂ の薬剤は、いずれも無菌試験法に適合する。"
      },
      {
        "key": 2,
        "text": "処方 ₁ と処方 ₂ の薬剤は、いずれも吸入剤の空気力学的粒度測定法に適合す"
      },
      {
        "key": 3,
        "text": "処方 ₁ の薬剤に用いられている容器は、薬剤を含むエアゾール缶、定量バルブ"
      },
      {
        "key": 4,
        "text": "処方 ₂ の薬剤は、吸入量が一定となるように調製された固体粒子のエアゾール"
      },
      {
        "key": 5,
        "text": "処方 ₂ の薬剤には、耐圧性の密封容器が用いられる。"
      }
    ],
    "correct_answer": 3,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 3,
        "text": "抗ウイルス薬の併用により、低血糖が発現する可能性が高まるため、ふらつき"
      },
      {
        "key": 4,
        "text": "抗ウイルス薬は、₁₂ 週間飲み続ける必要があるので、継続して受診してくださ"
      },
      {
        "key": 5,
        "text": "抗ウイルス薬により血圧が上昇する可能性がありますので、家庭でも血圧を測"
      }
    ],
    "correct_answer": 2,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 5,
        "text": "手指に Raynaud（レイノー）現象が認められる。"
      }
    ],
    "correct_answer": 2,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 3,
        "text": "LDL︲C 管理目標値は ₁₂₀ mg/dL である。"
      },
      {
        "key": 4,
        "text": "半年に一度の LDL アフェレシスを提案する。"
      },
      {
        "key": 5,
        "text": "筋肉痛と脱力感は、ロスバスタチンを継続投与しても自然に消失する。"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 5,
        "text": "腫瘍マーカーとして、SCC 抗原（squamous cell carcinoma related antigen）"
      }
    ],
    "correct_answer": 3,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 4,
        "text": "穿刺しても血液が出ない場合は、指先を強く押して血液を絞り出してくださ"
      },
      {
        "key": 5,
        "text": "₁ 回の穿刺で血液が測定用チップに十分に吸引できず測定できなかった場合"
      }
    ],
    "correct_answer": 1,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 5,
        "text": "点滴治療開始後は、同一成分の自己注射を希望しても変更することはできませ"
      }
    ],
    "correct_answer": 1,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 3,
        "text": "血漿製剤には血球成分は含まれていないため、使用前の血液型の確認は必要な"
      },
      {
        "key": 4,
        "text": "照射されている血液製剤とは、輸血による移植片対宿主病（GVHD）予防目的"
      },
      {
        "key": 5,
        "text": "新鮮凍結血漿︲LR「日赤」は、放射線部で照射後に使用すること。"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 2,
        "text": "便の中にお薬が見える場合は、薬が吸収されていない可能性があるため、すぐ"
      },
      {
        "key": 3,
        "text": "このお薬を飲むと食欲が低下することがあるため、症状がひどい場合は相談し"
      },
      {
        "key": 4,
        "text": "このお薬の飲み忘れに気付いたら、何時でもかまいませんのでできるだけ早く"
      },
      {
        "key": 5,
        "text": "このお薬は、用法・用量を守って服用していれば依存性は出現しません。"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 3,
        "text": "注入前の作動確認として、安全カバーを指でペン本体に押し込み、動くことを"
      },
      {
        "key": 4,
        "text": "手を怪我するなどにより、ペンを注射部位に深く押し込むことができなくなっ"
      },
      {
        "key": 5,
        "text": "注射部位に対して斜め ₄₅ 度の角度で押し当て注入したか。"
      }
    ],
    "correct_answer": 4,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 2,
        "text": "管理指導に携わる薬剤師は、 ₅ 年以上の実務経験が求められる。"
      },
      {
        "key": 3,
        "text": "保険薬局の指定を受けていれば、この管理指導に関する実施について、あらた"
      },
      {
        "key": 4,
        "text": "₁ ケ月に請求できる訪問回数に制限が設けられている。"
      },
      {
        "key": 5,
        "text": "訪問時に居宅サービスの変更につながる情報を得た場合でも、医師以外の関係"
      }
    ],
    "correct_answer": 2,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 3,
        "text": "情報提供書案：処方 ₁ の薬剤について ₁ 日 ₁ 回朝食後に変更の提案をすること"
      },
      {
        "key": 4,
        "text": "情報提供書案：処方 ₁ の薬剤の副作用発現の可能性が高いこと"
      },
      {
        "key": 5,
        "text": "情報提供書案：処方 ₂ の薬剤の副作用発現の可能性が高いこと"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 2,
        "text": "パロキセチン       ―   セント・ジョーンズワート     よる症状が現れる"
      },
      {
        "key": 3,
      ...
      {
        "key": 4,
        "text": "レボフロキサシン     ―   マグネシウム"
      },
      {
        "key": 5,
        "text": "アミノフィリン      ―   カフェイン            激作用が現れるこ"
      }
    ],
    "correct_answer": 3,
    "explanation": "",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "key": 2,
        "text": "手袋を中表にして外し、まだ手袋を着用している手で外した手袋を持ってお"
      },
      {
        "key": 3,
      ...
      {
        "key": 5,
        "text": "外した後、 ₂ 枚の手袋をひとかたまりになった状態で廃棄し、速乾性手指消毒"
      }
    ],
    "correct_answer": 3,
    "explanation": "",
