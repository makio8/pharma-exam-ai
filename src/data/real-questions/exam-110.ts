...
export const EXAM_110_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    "subject": "生物",
    "category": "必須問題 - 問 12",
    "question_text": "酸に含まれるプリン塩基のヒトにおける最終代謝産物はどれか。１つ選べ。",
    "choices": [],
    "correct_answer": 5,
  ...
  },
  {
    ...
    "subject": "衛生",
    "category": "必須問題 - 問 23",
    "question_text": "水道水質基準の基準項目に定められている大腸菌を特異的に検出するための基質はどれか。１つ選べ。",
    "choices": [],
    "correct_answer": 4,
  ...
  },
  {
    ...
    "subject": "薬剤",
    "category": "必須問題 - 問 45",
    "question_text": "下図は腎臓のネフロンを模式的に示したものである。図中の１〜５のうち、有機アニオントランスポーター（OAT1、OAT3）を介した薬物の輸送を表すのはどれか。１つ選べ。\nただし、図中の矢印の向きは薬物が移行する方向を示す。",
    "choices": [],
    "correct_answer": 3,
  ...
  },
  {
    ...
    "question_text": "ボルツマン分布は、異なるエネルギー準位E1、E2（E2＞E1）にある分子の数をそれぞれN1、N2としたとき、熱平衡状態における両者の比（R＝N2/N1）とエネルギー差（ΔE＝E2－E1）との間にある一定の関係を与える。この関係を表すグラフの概形として正しいのはどれか。１つ選べ。",
    "choices": [],
    "correct_answer": 3,
  ...
  },
  {
    ...
    "question_text": "以下の反応式のうち、右に示された主生成物が誤っているのはどれか。１つ選べ。\nただし、各反応はそれぞれ適切な溶媒を用いて行い、反応終了後、適切な後処理を施したものとする。",
    "choices": [],
    "correct_answer": 4,
  ...
  },
  {
    ...
    "question_text": "甲状腺ホルモン（T3、T4）はヨウ素を含むアミノ酸誘導体であるが、アミノ酸から直接作られるのではない。甲状腺濾胞における生合成過程では、タンパク質のチログロブリンが前駆物質となる。下図は、甲状腺濾胞においてT3、T4が作られるまでに、チログロブリンが移動する流れを示したものである。チログロブリンは甲状腺濾胞上皮細胞で作られてからコロイド中に分泌され、再び甲状腺濾胞上皮細胞に取り込まれ、最終的にT3、T4が濾胞外に分泌される。図中の１〜５のうち、チログロブリンのヨウ素化反応が行われる場所はどれか。１つ選べ。",
    "choices": [],
    "correct_answer": 3,
