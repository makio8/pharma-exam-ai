...
export const EXAM_110_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    "correct_answer": 3,
    "explanation": "１　誤\n造血幹細胞は、様々な血球に分化できる複能性幹細胞である。なお、単能性幹細胞とは、1種類の細胞にのみ分化できる幹細胞である。\n\n２　誤\n組織幹細胞は、体内の特定の組織に存在する幹細胞であり、造血幹細胞や神経系幹細胞、骨格筋幹細胞などがある。幹細胞の細胞分裂の様式として、大きさや性質が同じ娘細胞が形成される対称細胞分裂や、異なる大きさや性質をもった娘細胞が形成される非対称細胞分裂がある。前者は、組織の大きさを定義し、後者は細胞腫の多様性を促進する。\n\n３　正\n人工多能性幹細胞（iPS細胞）は、成体の体細胞に複数の遺伝子を導入し、分化状態を初期化することにより作製される。\n\n４　正\n胚性幹細胞（ES細胞）は、初期胚の内部細胞塊から樹立される。\n\n５　誤\n幹細胞は、どのような種類の細胞に分化できるのかという分化能により識別される。受精卵は、胚体外組織も含んだ全ての組織を作り出す能力である全能性をもつ。これに対してES細胞は、胚体外組織には分化できないが、全ての胚体組織に分化できる能力である多能性をもつ。",
    "tags": []
  },
  {
    "id": "r110-114",
